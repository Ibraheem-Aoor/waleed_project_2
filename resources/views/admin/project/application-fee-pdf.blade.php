...
<body>
    ...
    <div class="full-width {{ $text_direction }}">
        <div class="full-width {{ $text_direction }}">
            <h3>{{ __('custom.sidebar.application_fees') }}</h4>
        </div>
        <table class="full-width stripped-table {{ $text_direction }}" style="dir:rtl !important;">
            ...
            <tbody>
                @foreach ($project->applicationFees as $transaction)
                    <tr class="">
                        @if ($text_direction == 'text-right')
            ...
            <tfoot id="colored-tfoot" class="text-danger">
                <tr>
                    @if ($text_direction == 'text-right')
                        <td colspan="2">
                            {{ $project->getApplicationFeesTotalAmount() }}
                        </td>
                        <td colspan="2">
                            {{ __('custom.pdf.total') }}
                        </td>
                ...
                <tr>
                    @if ($text_direction == 'text-right')
                        <td colspan="2">
                            {{ $project->getApplicationFeesTotalPaidAmount() }}
                        </td>
                        <td colspan="2">
                ...
                <tr>
                    @if ($text_direction == 'text-right')
                        <td colspan="2">
                            {{ $project->getApplicationFeesTotalAmount() - $project->getApplicationFeesTotalPaidAmount() }}
                        </td>
                        <td colspan="2">
