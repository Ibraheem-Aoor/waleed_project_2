...
<body>
    ...
    <div class="full-width {{ $text_direction }}">
        <div class="full-width {{ $text_direction }}">
            <h3>{{ __('custom.sidebar.tenders') }}</h4>
        </div>
        <table class="full-width stripped-table {{ $text_direction }}" style="dir:rtl !important;">
            ...
            <tbody>
                @foreach ($project->tenders as $transaction)
                    <tr class="">
                        @if ($text_direction == 'text-right')
            ...
            <tfoot id="colored-tfoot" class="text-danger">
                ...
                <tr>
                    @if ($text_direction == 'text-right')
                        <td colspan="2">
                            {{ $project->getTendersTotalPaidAmount() }}
                        </td>
                        <td colspan="2">
                ...
                <tr>
                    @if ($text_direction == 'text-right')
                        <td colspan="2">
                            {{ $project->getTendersTotalAmount() - $project->getTendersTotalPaidAmount() }}
                        </td>
                        <td colspan="2">
